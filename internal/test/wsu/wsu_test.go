...
var (
	...
	// wmcbPinnedURL is the url of an arbitrary WMCB release
	wmcbPinnedURL = "https://github.com/openshift/windows-machine-config-operator/releases/download/0.2/wmcb.exe"
	// wmcbPinnedURLSha256 is the sha256 of the WMCB release specified by wmcbPinnedURL
	wmcbPinnedURLSha256 = "80674de2ff6bc1223d3a636cfa9217ddd8ef8c58f490b4c7c9999119a023c5ad"
)
...
func TestPinnedWMCB(t *testing.T) {
	...
	assert.Equal(t, wmcbPinnedURLSha256, fmt.Sprintf("%x", downloadedWMCBSha),
		"Downloaded WMCB has different SHA256 than expected")
